...
export default function ProjectAssignment() {
  ...
  const [isShowAcceptConfirmModal, setIsShowAcceptConfirmModal] =
    useState(false);
  const [projectAcceptId, setProjectAcceptId] = useState<number>();
  ...
  return (
    <div className="relative overflow-x-auto sm:rounded-lg cursor-default">
      ...
      {isShowAcceptConfirmModal && projectAcceptId && <AcceptProjectModal setIsShowAcceptConfirmModal ={setIsShowAcceptConfirmModal} projectAcceptId = {projectAcceptId} />}
