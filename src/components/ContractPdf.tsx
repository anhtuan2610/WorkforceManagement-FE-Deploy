    ...
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.section}>
        <Text style={styles.bold}>
          Hôm nay, ngày ... tháng ... năm 2024, chúng tôi gồm: ... và ...
        </Text>
        ...
        >
          <Text>Đại diện: ……………………..</Text>
          <Text style={{ marginRight: "100px" }}>Chức vụ: ……………………..</Text>
        </View>
      ...
      <View style={styles.section}>
        ...
        <Text style={{ fontSize: "13px", fontWeight: "bold" }}>
          TRUNG TÂM SOC – TỔ CHỨC GIÁO DỤC FPT
        </Text>
        <Text>Đại diện: Ông Phan Trường Lâm</Text>
      ...
      <View style={styles.section}>
        ...
        <Text>
          - “Bên cung cấp dịch vụ” là Công Ty XXXXXXXXXXXX. Sau đây gọi tắt là
          Bên B
        </Text>
      </View>
      ...
      <View style={styles.table}>
        ...
        <View style={styles.tableRow}>
          ...
          <Text style={styles.tableCell}>Dịch vụ kiểm thử bảo mật</Text>
          <Text style={styles.tableCell}>1</Text>
          <Text style={styles.tableCell}>10,000,000</Text>
          <Text style={styles.tableCell}>11/12/2024</Text>
          <Text style={styles.tableCell}>15%</Text>
          <Text style={styles.tableCellHeader}>11,500,000</Text>
        </View>
        <View style={styles.tableRow}>
          <Text style={styles.tableCell}>1</Text>
          <Text style={styles.tableCell}>Dịch vụ kiểm thử bảo mật</Text>
      ...
      <View>
        ...
        <View style={{ marginLeft: "15px" }}>
          <Text>
            1. Gói dịch vụ sẽ được kích hoạt kể từ ngày ………….(là ngày hết hạn
            của gói dịch vụ đã mua trước đó) nếu Bên A thanh toán đầy đủ phí
      ...
      <View>
        ...
        <View style={{ marginLeft: "15px" }}>
          {" "}
          <Text>
            1. Tổng phí dịch vụ: ………. đồng (sản phẩm không chịu thuế VAT theo
            quy định của Nhà nước). (Bằng chữ : ………………………………. đồng)
          </Text>
          <Text>
      ...
      >
        <View>
          ...
          <Text style={{ fontWeight: "bold" }}>{isAgreed && customerName}</Text>
        </View>
        <View
          style={{
            display: "flex",
...
export default function ContractPdf() {
  ...
  const handleAgreeClick = () => {
    setIsAgreed(true); // Đánh dấu rằng người dùng đã đồng ý
  };
  return (
    <div style={{ textAlign: "center", marginTop: "20px" }}>
      ...
      <div style={{ marginBottom: "20px" }}>
        <button
          style={{
            padding: "10px 20px",
            fontSize: "16px",
            backgroundColor: !isAgreed ? "#4CAF50" : "#d3d3d3", // Màu nền thay đổi khi bị vô hiệu hóa
            color: !isAgreed ? "white" : "#a9a9a9", // Màu chữ thay đổi khi bị vô hiệu hóa
            border: "none",
            borderRadius: "5px",
            cursor: !isAgreed ? "pointer" : "not-allowed", // Trạng thái con trỏ thay đổi
            textTransform: "uppercase",
          }}
          onClick={handleAgreeClick}
          disabled={!!isAgreed} // Nút bị vô hiệu hóa nếu isAgreed là false
        >
          Tôi đồng ý
        </button>
        <div>
      ...
      <BlobProvider
        document={
          <ContractDocument isAgreed={isAgreed} customerName={user?.fullName} />
        }
      >
        {({ url }) =>
