  ...
  return (
    <div className="p-4 max-w-lg mx-auto bg-gray-50 shadow-md rounded-md my-10">
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center">
          <strong className="w-1/3 text-gray-700">
            Tax Identification Number (TIN):
          </strong>
          <span className="text-gray-900 w-2/3 bg-gray-100 px-4 py-2 rounded-md font-bold">
            {ticketForm.taxCode}
          </span>
        </div>

        {/* <div className="flex items-center">
          <strong className="w-1/3 text-gray-700">Email Contact:</strong>
          <span className="text-gray-900 w-2/3 bg-gray-100 px-4 py-2 rounded-md">
            {ticketForm.emailContact}
          </span>
        </div> */}
      </div>
