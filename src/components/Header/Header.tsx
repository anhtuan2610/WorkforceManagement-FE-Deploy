    ...
    <div className="flex justify-between items-center h-[72px] w-full p-3 bg-[#FFFFFF] shadow gap-3 z-50">
      ...
      <div className="flex justify-center items-center gap-7">
        ...
        <div className="relative">
          <div className="flex justify-center items-center cursor-pointer" onClick={() => {setIsShow(!isShow)}}>
            <div className="w-11 h-11 flex justify-center rounded-full bg-slate-300 overflow-hidden">
          ...
          <div className={isShow ? "block" : "hidden"}>
            <div className="absolute bg-white w-44 shadow-md rounded-lg px-4 py-4 flex flex-col items-start gap-5 top-[58px] -right-1 ">
              ...
              <div className="flex items-center gap-2 cursor-pointer" onClick={() => navigate("contact")}>
